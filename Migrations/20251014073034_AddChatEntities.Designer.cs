...
namespace FYP2025.Migrations
{
    ...
    [Migration("20251014073034_AddChatEntities")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FYP2025.Domain.Entities.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FYP2025.Domain.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FYP2025.Domain.Entities.Conversation", b =>
                {
                    b.HasOne("FYP2025.Infrastructure.Data.ApplicationUser", "User1")
                        .WithMany()
                        .HasForeignKey("User1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FYP2025.Infrastructure.Data.ApplicationUser", "User2")
                        .WithMany()
            ...
            modelBuilder.Entity("FYP2025.Domain.Entities.Message", b =>
                {
                    b.HasOne("FYP2025.Domain.Entities.Conversation", "Conversation")
                        .WithMany("Messages")
                        .HasForeignKey("ConversationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FYP2025.Infrastructure.Data.ApplicationUser", "Sender")
                        .WithMany()
